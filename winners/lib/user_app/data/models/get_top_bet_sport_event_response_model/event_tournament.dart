...
class EventTournament extends Equatable {
  ...
  factory EventTournament.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [EventTournament].
  factory EventTournament.fromJson(String data) {
    return EventTournament.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [EventTournament] to a JSON string.
  String toJson() => json.encode(toMap());

  EventTournament copyWith({
    int? tournamentId,
