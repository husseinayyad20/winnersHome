...
class SportTopLeague extends Equatable {
  ...
  factory SportTopLeague.fromMap(Map<String, dynamic> data) {
    return SportTopLeague(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [SportTopLeague].
  factory SportTopLeague.fromJson(String data) {
    return SportTopLeague.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [SportTopLeague] to a JSON string.
  String toJson() => json.encode(toMap());

  SportTopLeague copyWith({
    int? tournamentId,
